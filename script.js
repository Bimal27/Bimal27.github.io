...
button === null || button === void 0 ? void 0 : button.addEventListener("click", function () {
    var inputsearch = document.getElementsByClassName("input-value")[0].value;
...
var displayData = function (data) {
    ...
    card.innerHTML = "<div class=\"left-panel panel\">\n               <div class=\"city\">\n                <div class='circle' style='background-color: green'></div>\n                  <span>" + data.name + "," + data.sys.country + "</span>\n                  <p class='description'>" + data.weather[0].description + "</p>\n                </div>\n                <div class=\"temp\">\n                   <img src=\"https://openweathermap.org/themes/openweathermap/assets/vendor/owm/img/widgets/" + data
        .weather[0].icon + ".png\" alt=\"\" width=\"120\">\n                   " + Math.ceil(data.main.temp - 273.15) + "\u00B0C\n                </div>\n                <div class=\"right-panel panel\">\n                    <p>Details</p>\n                    <hr></hr>\n                   <div class=\"data\">\n                      Feels like:  <span class='temp'>" + Math.round(data.main.feels_like - 273.15) + "\u00B0C </span>\n                  </div>\n                  <div class=\"data\">\n                      Humidity: <span class='temp'>" + data.main
        .humidity + "%  </span>\n                  </div>\n                  <div class=\"data\">\n                      Wind: <span class='temp'>" + data.wind.speed + " m/s  </span>\n                  </div>\n                  <div class=\"data\">\n                      Pressure: <span class='temp'>" + data.main
        .pressure + " hPa </span>\n                  </div>\n               </div>\n            </div> ";
};
var searchWeather = function (cityname) { return __awaiter(void 0, void 0, void 0, function () {
    var url, response, data, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                url = "https://api.openweathermap.org/data/2.5/weather?q=" + cityname + "&appid=e41fedf1448b1e63a9033e3b95264634";
                _a.label = 1;
            case 1:
                _a.trys.push([1, 5, , 6]);
